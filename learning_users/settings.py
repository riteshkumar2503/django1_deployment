...
SECRET_KEY = '&07fy8liwd5%evga%9ud)=_#%@3a4io5==a0#$c@ugcun0v1du'
...
ALLOWED_HOSTS = ["*"]  # any  ip  dene ke liye ye karna hai
...
LOGIN_URL = '/basic_app/login'  # The URL  where requests are redirected for login when using the login_required() decorator.